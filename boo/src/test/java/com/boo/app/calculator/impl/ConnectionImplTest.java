...
public class ConnectionImplTest {
    ...
    public void testExpressionReader() throws Exception {
        ConnectionImpl connection = new ConnectionImpl(null, null);
    ...
    public void testConnectionReadsExpressionAndReturnsResult() throws Exception {
        ...
        ConnectionImpl connection = new ConnectionImpl(mockedSocket, mockedServer);
        connection.run();

        String expected = expression + " = 8.0\n";
